...
/**
  * This is an event sourced entity. It has a state, [[NcowState]], which
  ...
  */
class NcowEntity extends PersistentEntity {

  override type Command = NcowCommand[_]
  override type Event = NcowEvent
  override type State = NcowState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: NcowState = NcowState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case NcowState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        NcowState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class NcowState(message: String, timestamp: String)
...
object NcowState {
  /**
    ...
    */
  implicit val format: Format[NcowState] = Json.format
}

/**
  * This interface defines all the events that the NcowEntity supports.
  */
sealed trait NcowEvent extends AggregateEvent[NcowEvent] {
  def aggregateTag = NcowEvent.Tag
}

object NcowEvent {
  val Tag = AggregateEventTag[NcowEvent]
}

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends NcowEvent
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends NcowCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends NcowCommand[String]
...
/**
  ...
  * application loader.
  */
object NcowSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[NcowState]
  )
}
